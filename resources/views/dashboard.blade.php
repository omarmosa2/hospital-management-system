...
<div class="space-y-6">
    ...
    <div class="gradient-bg rounded-2xl p-8 text-white animate-fadeInUp dark:bg-gradient-to-r dark:from-slate-800 dark:to-slate-900 dark:shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold mb-2 dark:text-slate-100">مرحباً، {{ Auth::user()->name }}</h1>
                <p class="text-blue-100 dark:text-slate-400 text-lg">مرحباً بك في نظام إدارة المستشفى</p>
