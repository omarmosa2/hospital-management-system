...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">{{ __('edit_patient') }}</h1>
            <p class="text-gray-600 mt-2">{{ __('edit_info') }}: {{ $patient->user->name }}</p>
        </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea id="medical_history" name="medical_history" rows="4"
                                  ...
                                  placeholder="{{ __('enter_previous_diseases_medical_conditions') }}">{{ old('medical_history', $patient->medical_history) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="allergies" name="allergies" rows="2"
                                  ...
                                  placeholder="{{ __('enter_known_allergies') }}">{{ old('allergies', $patient->allergies) }}</textarea>
                        @error('allergies')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
