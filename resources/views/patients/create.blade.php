...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">إضافة مريض جديد</h1>
            <p class="text-gray-600 mt-2">أدخل معلومات المريض الجديد</p>
        </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea id="medical_history" name="medical_history" rows="4"
                                  ...
                                  placeholder="أدخل أي أمراض سابقة أو حالات طبية مهمة...">{{ old('medical_history') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="allergies" name="allergies" rows="2"
                                  ...
                                  placeholder="أدخل أي حساسية معروفة...">{{ old('allergies') }}</textarea>
                        @error('allergies')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
