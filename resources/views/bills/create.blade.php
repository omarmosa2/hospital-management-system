...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">إنشاء فاتورة جديدة</h1>
            <p class="text-gray-600 mt-2">إنشاء فاتورة للمريض والخدمات</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <form action="{{ route('bills.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="border-b border-gray-200 pb-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">اختيار المريض</h3>
                <div>
            ...
            <!-- Services Selection -->
            <div class="border-b border-gray-200 pb-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">اختيار الخدمات</h3>
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('bills.index') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                    إلغاء
                </a>
