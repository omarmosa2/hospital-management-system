...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-slate-100">إضافة مصروف جديد</h1>
            <p class="text-gray-600 dark:text-slate-400 mt-2">قم بملء البيانات التالية لإضافة مصروف جديد</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label for="amount" class="block text-sm font-medium text-gray-700 dark:text-slate-300">
                            المبلغ <span class="text-red-500 dark:text-red-400">*</span>
                        </label>
                        <input type="number"
                               id="amount"
                               name="amount"
                    ...
                    <div class="space-y-2">
                        <label for="payment_method" class="block text-sm font-medium text-gray-700 dark:text-slate-300">
                            طريقة الدفع <span class="text-red-500 dark:text-red-400">*</span>
                        </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label for="expense_date" class="block text-sm font-medium text-gray-700 dark:text-slate-300">
                            تاريخ المصروف <span class="text-red-500 dark:text-red-400">*</span>
                        </label>
                        <input type="date"
                               id="expense_date"
                               name="expense_date"
