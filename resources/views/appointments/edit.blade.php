...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">تعديل الموعد</h1>
            <p class="text-gray-600 mt-2">تعديل تفاصيل الموعد</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <form action="{{ route('appointments.update', $appointment) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="border-b border-gray-200 pb-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">المريض والطبيب</h3>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="mt-6">
                    ...
                    <textarea id="reason" name="reason" rows="3"
                              ...
                              placeholder="أدخل سبب الموعد أو الأعراض...">{{ old('reason', $appointment->reason) }}</textarea>
                    @error('reason')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="pb-6">
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="4"
                              ...
                              placeholder="أي ملاحظات إضافية حول الموعد...">{{ old('notes', $appointment->notes) }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
