...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">الرواتب</h1>
            <p class="text-gray-600 mt-2">إدارة رواتب الأطباء وتوزيع الإيرادات</p>
        </div>
        <div class="mt-4 md:mt-0">
            <button onclick="window.print()" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center">
                ...
                <div class="mr-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">${{ number_format($totalPayments, 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center">
                ...
                <div class="mr-4">
                    <h3 class="text-sm font-medium text-gray-500">إجمالي رواتب الأطباء</h3>
                    <p class="text-2xl font-bold text-gray-900">${{ number_format($totalDoctorSalaries, 2) }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-lg">
            <div class="flex items-center">
                ...
                <div class="mr-4">
                    <h3 class="text-sm font-medium text-gray-500">حصة العيادات</h3>
                    <p class="text-2xl font-bold text-gray-900">${{ number_format($totalClinicShare, 2) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">تفاصيل رواتب الأطباء</h3>
        </div>
