...
@section('title', __('add_new_clinic'))
...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-slate-100">{{ __('add_new_clinic') }}</h1>
            <p class="text-gray-600 dark:text-slate-400 mt-2">{{ __('fill_data_to_add') }} {{ __('clinics') }}</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea id="description"
                              ...
                              placeholder="{{ __('enter_brief_clinic_description') }}">{{ old('description') }}</textarea>
                            @error('description')
                        <p class="text-red-500 dark:text-red-400 text-sm mt-1">{{ $message }}</p>
                            @enderror
                </div>
