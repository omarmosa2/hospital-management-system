...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-slate-100">تفاصيل العيادة</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-4">
                    <div class="flex items-start">
                        <div class="w-24 text-sm font-medium text-gray-500 dark:text-slate-400">الاسم:</div>
                        <div class="text-sm text-gray-900 dark:text-slate-100">{{ $clinic->name }}</div>
                    </div>

                    <div class="flex items-start">
                        <div class="w-24 text-sm font-medium text-gray-500 dark:text-slate-400">الوصف:</div>
                        <div class="text-sm text-gray-900 dark:text-slate-100">{{ $clinic->description ?? 'غير محدد' }}</div>
                    </div>

                    <div class="flex items-start">
                        <div class="w-24 text-sm font-medium text-gray-500 dark:text-slate-400">الموقع:</div>
                        <div class="text-sm text-gray-900 dark:text-slate-100">{{ $clinic->location ?? 'غير محدد' }}</div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        <div class="w-24 text-sm font-medium text-gray-500 dark:text-slate-400">الحالة:</div>
                        <div class="text-sm">
                            @if($clinic->is_active)
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg dark:shadow-slate-900 overflow-hidden">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="mr-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-slate-100">عدد الأطباء</h3>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg dark:shadow-slate-900 overflow-hidden">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="mr-4">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-slate-100">عدد المواعيد</h3>
                ...
                <div class="border border-gray-200 dark:border-slate-600 rounded-lg p-4 hover:shadow-md transition-shadow duration-200 bg-white dark:bg-slate-700">
                    <div class="flex items-start justify-between mb-3">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-slate-400">{{ $doctor->specialty ?? 'غير محدد' }}</p>
                        </div>
                        <div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg dark:shadow-slate-900 overflow-hidden">
        <div class="p-6">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center space-x-4 mb-2">
                                ...
                                <span class="text-sm text-gray-500 dark:text-slate-400">مع د. {{ $appointment->doctor->user->name }}</span>
                            </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-500 dark:text-slate-400">عرض 10 من أصل {{ $clinic->appointments->count() }} موعد</p>
            </div>
            @endif
        </div>
    </div>
